package Net::EvalServer::Child;
BEGIN {
  $Net::EvalServer::Child::AUTHORITY = 'cpan:HINRIK';
}
BEGIN {
  $Net::EvalServer::Child::VERSION = '0.01';
}
...
sub run {
    ...
    my $class = "Net::EvalServer::Language::$lang";
    eval "require $class";
    chomp $@;
    _fail($@) if $@;
...
Net::EvalServer::Child - Evaluato code in a safe child process

=head1 SYNOPSIS

 # fork, etc

 use Net::EvalServer::Child;
 Net::EvalServer::Child::run(
...
suffix (e.g. 'Perl' for C<Net::EvalServer::Language::Perl>), the code, and
